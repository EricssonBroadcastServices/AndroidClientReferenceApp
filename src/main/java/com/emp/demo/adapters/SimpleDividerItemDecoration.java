 ...
 */
public class  SimpleDividerItemDecoration extends LinearLayoutManager {
    private final int duration;

    public SimpleDividerItemDecoration(Context context, int orientation, boolean reverseLayout, int duration) {
    ...
    private class SmoothScroller extends LinearSmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
            return SimpleDividerItemDecoration.this
